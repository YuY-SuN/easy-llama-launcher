...
class LLMRepository:
    ...
    def set(self, llm_dto: LLMDTO):
        ...
        llm = LLM(model_name=llm_dto.model_name, chat_template=llm_dto.chat_template, nickname=llm_dto.nickname)
    ...
    def get_by_model_name(self, model_name: str) -> LLMDTO:
        ...
        return LLMDTO(namespace="", model_name=llm.model_name, chat_template=llm.chat_template, nickname=llm.nickname) if llm else None
